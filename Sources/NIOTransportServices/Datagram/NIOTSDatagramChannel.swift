...
internal final class NIOTSDatagramChannel: StateManagedNWConnectionChannel {
    ...
    internal var isActive0: Atomics.ManagedAtomic<Bool> = ManagedAtomic(false)
    ...
    internal var _options: ConnectionChannelOptions = ConnectionChannelOptions()
...
extension NIOTSDatagramChannel: Channel, ChannelCore {
    ...
    public var isWritable: Bool {
        return self._backpressureManager.writable.load(ordering: .sequentiallyConsistent)
    }
...
//    }
    ...
    private func setOption0<Option: ChannelOption>(option: Option, value: Option.Value) throws {
        ...
        case is NIOTSChannelOptions.Types.NIOTSEnablePeerToPeerOption:
            self._enablePeerToPeer = value as! NIOTSChannelOptions.Types.NIOTSEnablePeerToPeerOption.Value
        default:
